...
public class MovimientosDaoImp implements MovimientosDao {
	...
	public void registrar(Movimientos mov) {
		...
		entityManager.createNativeQuery(
				...
				+ "(id_movim,fecha_movim,num_pago,valor_concepto,cantidad_movim,total_movim,notas_info,notas_concepto,id_benef,id_pago,id_concepto,id_emp,id_cuenta,id_impuesto,id_retencion,id_tipo_mov) "
				+ "VALUES ("+mov.getId_movim() + mov.getFecha_movim() + mov.getNum_pago() + mov.getValor_concepto() + mov.getCantidad_movim() + mov.getTotal_movim() + mov.getNotas_info() + mov.getNotas_concepto() + mov.getId_benef() + mov.getId_pago() + mov.getId_concepto() + mov.getId_emp() + mov.getId_cuenta() + mov.getId_impuesto() + mov.getId_retencion() + mov.getId_tipo_mov() +")")
		.executeUpdate();
		*/
		...
		.setParameter("num_pago",mov.getNum_pago())
		...
		.setParameter("notas_info",mov.getNotas_info())
		.setParameter("notas_concepto",mov.getNotas_concepto())
